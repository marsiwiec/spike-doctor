...
def _phase_error(status: str) -> dict:
    return {
        "voltage": None,
        "dvdt": None,
        "sweep": None,
...
def _prepare_phase_plot_data(
    ...
    if spiking.empty:
        return _phase_error("Rheobase Not Found")
